...
HelloWorld2::HelloWorld2(const HelloWorld2& string) {
    hello = new char[strlen(string.hello) + 1];
    world = new char[strlen(string.world) + 1];

    strcpy(string.hello, this->hello);
    strcpy(string.world, this->world);
}
